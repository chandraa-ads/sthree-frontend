...
export function Hero() {
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-coral/10 via-white to-turquoise/10">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        >
          ...
          >
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-turquoise">500+</div>
