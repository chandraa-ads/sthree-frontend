    ...
    >
      ...
      <div className="relative aspect-[3/4] overflow-hidden">
        ...
        {!isMobile ? (
          ...
          >
            <Heart
              className={`w-3.5 h-3.5 sm:w-4 sm:h-4 transition-colors duration-300 ${isWishlisted ? "text-red-500 fill-red-500" : "text-gray-600 hover:text-pink-600"
                }`}
            />
          </motion.button>
        ) : (
          ...
          >
            <Heart
              className={`w-4 h-4 transition-colors duration-300 ${isWishlisted ? "text-red-500 fill-red-500" : "text-gray-600"
                }`}
            />
          </button>
        )}
